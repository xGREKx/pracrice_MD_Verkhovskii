...
const Prof = ({navigation}) => {
  return (
     <View style={{justifyContent: 'center', alignItems: 'center', padding: 24, }}>
      <Text style={styles.paragraph}>Миротворец</Text>
      <Image style={styles.logo} source={require('./assets/prof1.jpg')}/>
      <Text style={styles.textread}>Телефон:</Text>
      <Text style={styles.phonetext}>+7(812)810-51-44</Text>
      ...
      <View>
         ...
         <Text style ={styles.text_phone2}>+7(812)387-66-19</Text>
                 <Pressable
